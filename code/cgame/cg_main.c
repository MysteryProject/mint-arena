...
static cvarTable_t cgameCvarTable[] = {
	...
	{&cg_drawCrosshair, "cg_drawCrosshair", "1", CVAR_ARCHIVE, RANGE_INT(0, NUM_CROSSHAIRS)},
...
#endif
	{&cg_forceModel, "cg_forceModel", "0", CVAR_ARCHIVE, RANGE_ALL},
...
//		}
	...
	cgs.media.sfx_minirailexp = trap_S_RegisterSound("sound/weapons/minirail/railexp.wav", qfalse);
#ifdef MISSIONPACK
...
static void CG_RegisterGraphics( void ) {
	...
	for ( i = 0 ; i < NUM_CROSSHAIRS ; i++ ) {
		cgs.media.crosshairShader[i] = trap_R_RegisterShader( va("crosshairs/crosshair%d", i+1) );
	}
