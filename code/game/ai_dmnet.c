...
int BotSelectActivateWeapon(bot_state_t *bs)
{
	...
	else if (bs->inventory[INVENTORY_TAPRIFLE] > 0 && bs->inventory[INVENTORY_BULLETS] > 0)
		return WEAPONINDEX_TAPRIFLE;
	else if (bs->inventory[INVENTORY_MINIRAIL] > 0 && bs->inventory[INVENTORY_SLUGS] > 0)
