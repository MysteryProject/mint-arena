...
void UI_MainMenu(void)
{
	...
	s_main.debug.generic.callback = Main_MenuEvent;
	s_main.debug.string = "Debug";
	s_main.debug.color = text_big_color;
	s_main.debug.style = style;
	...
	Menu_AddItem(&s_main.menu, &s_main.debug);
